#!/usr/bin/env node
/**
 * Regenerates template-antd-shared/src/lib/theme/google-fonts.ts from Google's public font
 ...
 * never need network access to the endpoint or an API key of their own. Ported unchanged
 * from the sibling shadcn kit's scripts/generate-google-fonts.mjs.
 *
...
const outPath = path.join(root, 'template-antd-shared/src/lib/theme/google-fonts.ts')
